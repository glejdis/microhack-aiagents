"""Challenge 3 — MCP server exposing the CLM workflow as reusable tools.
...
Run (stdio, for an MCP client to launch):
    python challenge-3/mcp_server/server.py

Then point VS Code at it via challenge-3/.vscode/mcp.json.
"""
