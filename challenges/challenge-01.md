...
### Task 3 · Deploy the resources (~8 min)

> [!IMPORTANT]
> Depending on the setup for your event, the Azure resources may already be provisioned for you — in
> which case you can **skip to Task 5**. Check with your coach what applies.
...
| `Select an Azure Subscription` | the subscription you set in Task 2 (arrow keys → Enter) |
