...
Run:  python scripts/make_step_placeholders.py
...
SLOTS: list[tuple[str, str, str, str]] = [
    ...
    ("challenge-0", "08-foundry-deployments", "Foundry Portal · Model deployments",
     "Foundry portal → Models + endpoints showing gpt-5.4, gpt-5-mini and claude-sonnet-4-5 as 'Succeeded'."),
...
def main() -> int:
    ...
    for challenge, fname, title, caption in SLOTS:
        steps_dir = REPO_ROOT / challenge / "images" / "steps"
