#!/usr/bin/env bash
# ==========================================================================
# Challenge 0 (coach/setup) — create the Microsoft Entra app registration the
...
#   - Sites.ReadWrite.All  → lets scripts/upload_corpus_to_sharepoint.py upload
...
#     an admin must run — or follow the manual portal steps in the Ch0 README.
#
# Usage:  bash scripts/setup_sharepoint_app.sh ["Display Name"]
# ==========================================================================
set -euo pipefail
...
======================================================================
 ...
 Next: python scripts/upload_corpus_to_sharepoint.py  (then seed_corpus.py)
EOF
