...
- `.env` populated — the deploy script / `azd` postprovision hook autofills it via
  [`labautomation/write_env.py`](../../labautomation/write_env.py).
- The corpus is crawled into the `clm-corpus` Azure AI Search index by
  [`labautomation/seed_corpus.py`](../../labautomation/seed_corpus.py) (SharePoint path)
  or the local-PDF fallback over [`src/data/`](../../src/data/).
- **Done when** [`labautomation/smoke_test.py`](../../labautomation/smoke_test.py)
...
| [`labautomation/seed_corpus.py`](../../labautomation/seed_corpus.py) | Seeds the `clm-corpus` index (SharePoint crawl or local-PDF fallback) |
| [`labautomation/seed_sql.py`](../../labautomation/seed_sql.py) | Optional: seeds contract-status rows in Azure SQL |
| [`labautomation/smoke_test.py`](../../labautomation/smoke_test.py) | Gate — confirms both model runners answer |
...
| Corpus / index empty | Re-run `python labautomation/seed_corpus.py` (idempotent). |
