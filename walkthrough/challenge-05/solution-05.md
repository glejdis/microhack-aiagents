...
3. Fill the **"Publish to Teams and Microsoft 365"** form (name, descriptions, **More** → developer website / terms / privacy) → **Next: Publish options** (older builds label this **Prepare Agent**) → choose **Individual scope** → **Submit**. The form auto-packages icons; only the **Download & customize** route needs the **192×192** + **32×32** placeholders in [`src/manifest/`](../../src/manifest/). Find it in Teams under **Apps → Your agents**. *(If direct publish returns a **400**, use the **Download & customize** tab and sideload the zip.)*
